...
func (c *Car) Encode(_m *SbeGoMarshaller, _w io.Writer, doRangeCheck bool) error {
	...
	for idx := 0; idx < 2; idx++ {
		if err := _m.WriteInt64(_w, c.Uuid[idx]); err != nil {
			return err
		}
	}
	if err := _m.WriteUint8(_w, c.CupHolderCount); err != nil {
		return err
	}
...
func (c *Car) Decode(_m *SbeGoMarshaller, _r io.Reader, actingVersion uint16, blockLength uint16, doRangeCheck bool) error {
	...
	if !c.UuidInActingVersion(actingVersion) {
		for idx := 0; idx < 2; idx++ {
			c.Uuid[idx] = c.UuidNullValue()
		}
	} else {
		for idx := 0; idx < 2; idx++ {
			if err := _m.ReadInt64(_r, &c.Uuid[idx]); err != nil {
				return err
			}
		}
	}
	if !c.CupHolderCountInActingVersion(actingVersion) {
		c.CupHolderCount = c.CupHolderCountNullValue()
	} else {
		if err := _m.ReadUint8(_r, &c.CupHolderCount); err != nil {
			return err
		}
	}
	...
	if c.PerformanceFiguresInActingVersion(actingVersion) {
		...
		for i, _ := range c.PerformanceFigures {
...
func (c *Car) RangeCheck(actingVersion uint16, schemaVersion uint16) error {
	...
	if c.UuidInActingVersion(actingVersion) {
		for idx := 0; idx < 2; idx++ {
			if c.Uuid[idx] < c.UuidMinValue() || c.Uuid[idx] > c.UuidMaxValue() {
				return fmt.Errorf("Range check failed on c.Uuid[%d] (%v < %v > %v)", idx, c.UuidMinValue(), c.Uuid[idx], c.UuidMaxValue())
			}
		}
	}
	if c.CupHolderCountInActingVersion(actingVersion) {
		if c.CupHolderCount != c.CupHolderCountNullValue() && (c.CupHolderCount < c.CupHolderCountMinValue() || c.CupHolderCount > c.CupHolderCountMaxValue()) {
			return fmt.Errorf("Range check failed on c.CupHolderCount (%v < %v > %v)", c.CupHolderCountMinValue(), c.CupHolderCount, c.CupHolderCountMaxValue())
		}
	}
	for _, prop := range c.FuelFigures {
...
func CarInit(c *Car) {
	c.DiscountedModel = Model.C
	for idx := 0; idx < 2; idx++ {
		c.Uuid[idx] = math.MinInt64
	}
	c.CupHolderCount = math.MaxUint8
	return
}
...
func (*Car) UuidId() uint16 {
	return 100
}

func (*Car) UuidSinceVersion() uint16 {
	return 1
}

func (c *Car) UuidInActingVersion(actingVersion uint16) bool {
	return actingVersion >= c.UuidSinceVersion()
}

func (*Car) UuidDeprecated() uint16 {
	return 0
}

func (*Car) UuidMetaAttribute(meta int) string {
	switch meta {
	case 1:
		return ""
	case 2:
...
func (*Car) UuidMinValue() int64 {
	return math.MinInt64 + 1
}

func (*Car) UuidMaxValue() int64 {
	return math.MaxInt64
}

func (*Car) UuidNullValue() int64 {
	return math.MinInt64
}

func (*Car) CupHolderCountId() uint16 {
	return 101
}

func (*Car) CupHolderCountSinceVersion() uint16 {
	return 1
}

func (c *Car) CupHolderCountInActingVersion(actingVersion uint16) bool {
	return actingVersion >= c.CupHolderCountSinceVersion()
}

func (*Car) CupHolderCountDeprecated() uint16 {
	return 0
}

func (*Car) CupHolderCountMetaAttribute(meta int) string {
	switch meta {
	case 1:
		return ""
	case 2:
...
func (*Car) CupHolderCountMinValue() uint8 {
	return 0
}

func (*Car) CupHolderCountMaxValue() uint8 {
	return math.MaxUint8 - 1
}

func (*Car) CupHolderCountNullValue() uint8 {
