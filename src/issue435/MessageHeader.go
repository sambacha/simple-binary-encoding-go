...
func (m *MessageHeader) Encode(_m *SbeGoMarshaller, _w io.Writer) error {
	...
	if err := m.S.Encode(_m, _w); err != nil {
		return err
	}
	return nil
}
...
func (m *MessageHeader) Decode(_m *SbeGoMarshaller, _r io.Reader, actingVersion uint16) error {
	...
	if m.SInActingVersion(actingVersion) {
		if err := m.S.Decode(_m, _r, actingVersion); err != nil {
			return err
		}
	}
	return nil
...
func (*MessageHeader) SSinceVersion() uint16 {
	return 0
}

func (m *MessageHeader) SInActingVersion(actingVersion uint16) bool {
	return actingVersion >= m.SSinceVersion()
}

func (*MessageHeader) SDeprecated() uint16 {
	return 0
}
