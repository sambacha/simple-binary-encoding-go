...
func (m *MessageHeader) Encode(_m *SbeGoMarshaller, _w io.Writer) error {
	if err := _m.WriteUint8(_w, m.BlockLength); err != nil {
		return err
	}
...
func (m *MessageHeader) Decode(_m *SbeGoMarshaller, _r io.Reader, actingVersion uint16) error {
	if !m.BlockLengthInActingVersion(actingVersion) {
		...
		if err := _m.ReadUint8(_r, &m.BlockLength); err != nil {
			return err
		}
	}
...
func (*MessageHeader) BlockLengthMinValue() uint8 {
	return 0
}

func (*MessageHeader) BlockLengthMaxValue() uint8 {
	return math.MaxUint8 - 1
}

func (*MessageHeader) BlockLengthNullValue() uint8 {
