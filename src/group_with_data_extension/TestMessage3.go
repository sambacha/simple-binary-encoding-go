...
func (t *TestMessage3Entries) Encode(_m *SbeGoMarshaller, _w io.Writer) error {
	...
	var NestedEntriesBlockLength uint16 = 16
...
func (t *TestMessage3EntriesNestedEntries) Encode(_m *SbeGoMarshaller, _w io.Writer) error {
	...
	if err := _m.WriteInt64(_w, t.InnerExtension); err != nil {
		return err
	}
...
func (t *TestMessage3EntriesNestedEntries) Decode(_m *SbeGoMarshaller, _r io.Reader, actingVersion uint16, blockLength uint) error {
	...
	if !t.InnerExtensionInActingVersion(actingVersion) {
		t.InnerExtension = t.InnerExtensionNullValue()
	} else {
		if err := _m.ReadInt64(_r, &t.InnerExtension); err != nil {
			return err
		}
	}
	if actingVersion > t.SbeSchemaVersion() && blockLength > t.SbeBlockLength() {
...
func (t *TestMessage3EntriesNestedEntries) RangeCheck(actingVersion uint16, schemaVersion uint16) error {
	...
	if t.InnerExtensionInActingVersion(actingVersion) {
		if t.InnerExtension < t.InnerExtensionMinValue() || t.InnerExtension > t.InnerExtensionMaxValue() {
			return fmt.Errorf("Range check failed on t.InnerExtension (%v < %v > %v)", t.InnerExtensionMinValue(), t.InnerExtension, t.InnerExtensionMaxValue())
		}
	}
...
func (*TestMessage3EntriesNestedEntries) InnerExtensionId() uint16 {
	return 8
}

func (*TestMessage3EntriesNestedEntries) InnerExtensionSinceVersion() uint16 {
	return 1
}

func (t *TestMessage3EntriesNestedEntries) InnerExtensionInActingVersion(actingVersion uint16) bool {
	return actingVersion >= t.InnerExtensionSinceVersion()
}

func (*TestMessage3EntriesNestedEntries) InnerExtensionDeprecated() uint16 {
	return 0
}

func (*TestMessage3EntriesNestedEntries) InnerExtensionMetaAttribute(meta int) string {
	switch meta {
	case 1:
		return ""
	case 2:
...
func (*TestMessage3EntriesNestedEntries) InnerExtensionMinValue() int64 {
	return math.MinInt64 + 1
}

func (*TestMessage3EntriesNestedEntries) InnerExtensionMaxValue() int64 {
	return math.MaxInt64
}

func (*TestMessage3EntriesNestedEntries) InnerExtensionNullValue() int64 {
	return math.MinInt64
}
