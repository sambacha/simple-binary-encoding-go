...
func (*VarDataEncoding) LengthMinValue() uint8 {
	return 0
}

func (*VarDataEncoding) LengthMaxValue() uint8 {
	return math.MaxUint8 - 1
}

func (*VarDataEncoding) LengthNullValue() uint8 {
...
func (*VarDataEncoding) VarDataMinValue() byte {
	return byte(32)
}

func (*VarDataEncoding) VarDataMaxValue() byte {
	return byte(126)
}

func (*VarDataEncoding) VarDataNullValue() byte {
	return 0
}
